      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
             ...
             <p className="text-slate-500 max-w-3xl ml-11">
               为了保障您的合法权益，维护良好的社区秩序，请您在使用薪画社服务前仔细阅读以下协议与规则。
               <br />最后更新日期：2023年10月1日
             </p>
          </div>
        </div>
          ...
          <div className="flex-1 space-y-10">
             ...
             <section id="service" className="scroll-mt-24">
                <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-8">
                   ...
                   <div className="text-slate-600 space-y-6 leading-relaxed">
                      <div>
                         <h4 className="font-bold text-slate-800 mb-2">1. 协议的范围</h4>
                         <p className="text-sm">
                      ...
                      <div>
                         <h4 className="font-bold text-slate-800 mb-2">2. 账号注册与使用</h4>
             ...
             <section id="privacy" className="scroll-mt-24">
                <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-8">
                   ...
                   <div className="text-slate-600 space-y-6 leading-relaxed">
                      ...
                      <div>
                         <h4 className="font-bold text-slate-800 mb-2">1. 信息收集</h4>
                         <p className="text-sm">
                      ...
                      <div>
                         <h4 className="font-bold text-slate-800 mb-2">2. 信息使用</h4>
                         <p className="text-sm">
             ...
             <section id="dispute" className="scroll-mt-24">
                <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-8">
                   ...
                   <div className="text-slate-600 space-y-6 leading-relaxed">
                      <div>
                         <h4 className="font-bold text-slate-800 mb-2">1. 纠纷介入流程</h4>
                         <p className="text-sm">
                      ...
                      <div>
                         <h4 className="font-bold text-slate-800 mb-2">2. 常见争议判定标准</h4>
                         <div className="overflow-x-auto border border-slate-200 rounded-lg">
                            <table className="w-full text-sm text-left">
                               <thead className="bg-slate-50 font-bold text-slate-700">
                                  <tr>
                                     <th className="p-3 border-b">争议类型</th>
                                     <th className="p-3 border-b">责任判定与处理</th>
                                  </tr>
                               </thead>
                               <tbody className="divide-y divide-slate-200">
                                  <tr>
                                     <td className="p-3 font-medium">画师拖稿/失联</td>
                                     <td className="p-3">全额退还企划方托管资金，画师扣除信用分并可能被封号。</td>
                                  </tr>
                                  <tr>
                                     <td className="p-3 font-medium">企划方无故拒付</td>
                                     <td className="p-3">若画师已按要求完成且多次修改，平台将强制支付相应阶段款项给画师。</td>
                                  </tr>
                                  <tr>
                                     <td className="p-3 font-medium">画风/质量不符</td>
                                     <td className="p-3">对比画师过往作品集与交付物。若严重不符，支持退款；若为主观审美差异，倾向于按进度支付辛苦费。</td>
                                  </tr>
                               </tbody>
                            </table>
                         </div>
                   ...
                   <div className="text-slate-600 space-y-4 text-sm">
                      <div className="border border-red-100 bg-red-50 p-4 rounded-lg">
                         <h4 className="font-bold text-red-800 mb-2 flex items-center gap-2">
                            <AlertTriangle className="w-4 h-4" /> 严重违规（永久封号）
                         </h4>
                      ...
                      <div className="border border-amber-100 bg-amber-50 p-4 rounded-lg">
                         <h4 className="font-bold text-amber-800 mb-2 flex items-center gap-2">
                            <AlertTriangle className="w-4 h-4" /> 一般违规（警告/禁言/短期封禁）
                         </h4>
             ...
             <section id="copyright" className="scroll-mt-24">
                <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-8">
                   ...
                   <div className="text-slate-600 space-y-6 leading-relaxed">
                      ...
                      <div>
                         <h4 className="font-bold text-slate-800 mb-2">1. 平台权利</h4>
                         <p className="text-sm">
                            平台页面设计、代码、Logo等知识产权归薪画社所有。
                         </p>
                      </div>
                      <div>
                         <h4 className="font-bold text-slate-800 mb-2">2. 用户权利</h4>
                         <p className="text-sm">
                            用户在平台发布的原创作品，著作权归作者所有。用户同意授予平台免费的、非独家的使用权，用于平台宣传展示。
                         </p>
                      </div>
                      <div>
                         <h4 className="font-bold text-slate-800 mb-2">3. 侵权投诉</h4>
                         <p className="text-sm">
